...
class qtype_hwtestnlab_question extends qtype_wq_question
    ...
    public function get_matching_answer_fail_test(array $response) {
        ...
        if ($error) {
            throw new moodle_exception(get_string('failedtogradetest', 'qtype_hwtestnlab',
    ...
    public function summarise_response(array $response) {
        ...
        if (!$this->is_text_answer()) {
            return get_string('contentnotviewable', 'qtype_hwtestnlab');
        } else {
