...
class restore_qtype_hwtestnlab_plugin extends restore_qtype_shortanswer_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        // Add own qtype stuff.
        $elename = 'shortanswer';
        $hwtestnlabelement = 'hwtestnlab';
        $xmlname = 'qtype_wq_hwtestnlab';
        // We used get_recommended_name() so this works.
        $elepath = $this->get_pathfor('/shortanswer');
        $hwtestnlabpath = $this->get_pathfor('/hwtestnlab');
        $xmlpath = '/question_categories/question_category/questions/question/plugin_qtype_hwtestnlab_question/question_xml';

        $paths[] = new restore_path_element($elename, $elepath);
        $paths[] = new restore_path_element($hwtestnlabelement, $hwtestnlabpath);
        $paths[] = new restore_path_element($xmlname, $xmlpath);
        return $paths; // And we return the interesting paths.
    }

    public function process_qtype_wq_hwtestnlab($data) {
        global $DB;
