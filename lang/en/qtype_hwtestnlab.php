...
$string['recogmodel'] = 'Type of characters for handwriting recognition';
$string['math'] = 'math';
...
$string['pluginnameadding'] = 'Adding a Handwriting short answer question';
$string['pluginnameediting'] = 'Editing a Handwriting short answer question';
...
$string['recognitionurl'] = 'Handwriting text recognition URL';
$string['recognitionurl_desc'] = 'URL to connenct to Handwriting-text Recognition server';
