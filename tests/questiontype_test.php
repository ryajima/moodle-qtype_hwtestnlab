...
global $CFG;
require_once($CFG->dirroot . '/question/type/hwtestnlab/questiontype.php');
...
class qtype_hwtestnlab_test extends advanced_testcase {
    public static $includecoverage = array(
        ...
        'question/type/hwtestnlab/questiontype.php',
    );

    protected $qtype;

    protected function setUp(): void {
        $this->qtype = new qtype_hwtestnlab();
    }
    ...
    protected function get_test_question_data() {
        return test_question_maker::get_question_data('hwtestnlab');
    }

    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'hwtestnlab');
    }
    ...
    public function test_get_random_guess_score() {
        $q = test_question_maker::get_question_data('hwtestnlab');
    ...
    public function test_get_possible_responses_no_star() {
        $q = test_question_maker::get_question_data('hwtestnlab', 'frogonly');
    ...
    public function test_question_saving_frogtoad() {
        ...
        $questiondata = test_question_maker::get_question_data('hwtestnlab');
        $formdata = test_question_maker::get_question_form_data('hwtestnlab');

        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category(array());

        $formdata->category = "{$cat->id},{$cat->contextid}";
        qtype_hwtestnlab_edit_form::mock_submit((array)$formdata);

        $form = qtype_hwtestnlab_test_helper::get_question_editing_form($cat, $questiondata);
