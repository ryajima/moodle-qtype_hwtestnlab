...
class qtype_hwtestnlab_test_helper extends question_test_helper {
    ...
    /**
     * Makes a hwtestnlab question with correct ansewer 'frog', partially
     * correct answer 'toad' and defaultmark 1. This question also has a
     * '*' match anything answer.
     * @return qtype_hwtestnlab_question
     */
    public function make_hwtestnlab_question_frogtoad() {
        question_bank::load_question_definition_classes('hwtestnlab');
        $sa = new qtype_hwtestnlab_question();
        ...
        $sa->qtype = question_bank::get_qtype('hwtestnlab');

        return $sa;
    }

    /**
     * Gets the question data for a hwtestnlab question with with correct
     * ansewer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_hwtestnlab_question_data_frogtoad() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'hwtestnlab';
    ...
    /**
     * Gets the question form data for a hwtestnlab question with with correct
     * answer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_hwtestnlab_question_form_data_frogtoad() {
        $form = new stdClass();
    ...
    /**
     * Makes a hwtestnlab question with just the correct ansewer 'frog', and
     * no other answer matching.
     * @return qtype_hwtestnlab_question
     */
    public function make_hwtestnlab_question_frogonly() {
        question_bank::load_question_definition_classes('hwtestnlab');
        $sa = new qtype_hwtestnlab_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'Short answer question';
    ...
    /**
     * Gets the question data for a hwtestnlab questionwith just the correct
     * ansewer 'frog', and no other answer matching.
     * @return stdClass
     */
    public function get_hwtestnlab_question_data_frogonly() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);
     ...
     * @return qtype_hwtestnlab_question
     */
    public function make_hwtestnlab_question_escapedwildcards() {
        question_bank::load_question_definition_classes('hwtestnlab');
        $sa = new qtype_hwtestnlab_question();
        test_question_maker::initialise_a_question($sa);
