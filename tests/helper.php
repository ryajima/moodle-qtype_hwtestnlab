...
class qtype_hwtestnlab_test_helper extends question_test_helper {
     ...
     * @return stdClass
     */
    public function get_hwtestnlab_question_form_data_algorithmsaw() {
        $form = new stdClass();
