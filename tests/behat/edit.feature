...
Feature: Test editing a Short answer question
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | hwtestnlab | hwtestnlab-001 for editing | frogtoad |
  ...
  Scenario: Edit a Short answer question
    When I choose "Edit question" action for "hwtestnlab-001" in the question bank
    And I set the following fields to these values:
      | Question name | |
    And I press "id_submitbutton"
    Then I should see "You must supply a value here."
    When I set the following fields to these values:
      | Question name | Edited hwtestnlab-001 name |
    And I press "id_submitbutton"
    Then I should see "Edited hwtestnlab-001 name"
    When I choose "Edit question" action for "Edited hwtestnlab-001" in the question bank
    And I set the following fields to these values:
      | id_answer_1          | newt                       |
      | id_fraction_1        | 70%                        |
    ...
    And I press "id_submitbutton"
    Then I should see "Edited hwtestnlab-001 name"
    When I choose "Preview" action for "Edited hwtestnlab-001" in the question bank
